...
export default async function NotificationsCallsPanel({ filter = 'all', q = '' }: { filter?: string; q?: string }) {
  ...
  return (
    <div className="notifications-calls-panel">
      ...
      <section className="calls-list" style={{ marginTop: 10 }}>
      ...
      <style>{`
        .notifications-calls-panel{margin-top:18px}.calls-page-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:18px;flex-wrap:wrap}.calls-page-heading h2{margin:0 0 4px;font-size:1.2rem}.ringcentral-calls-sync{display:grid;justify-items:end;gap:7px}.ringcentral-calls-sync-message{max-width:520px;padding:8px 10px;border-radius:9px;background:#eef6f1;color:#315b43;font-size:.78rem;font-weight:800;text-align:right}.calls-summary-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-top:14px}.calls-summary-card{display:grid;gap:5px}.calls-summary-card span{font-size:.74rem;font-weight:900;text-transform:uppercase;letter-spacing:.04em;color:#6c7a86}.calls-summary-card strong{font-size:1.75rem;color:#18324a}.calls-toolbar{margin-top:14px;display:grid;gap:12px}.calls-search-form{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.calls-search-form input[type=search]{flex:1;min-width:220px;min-height:42px;border:1px solid #cbd5e1;border-radius:10px;padding:9px 11px;background:#fff}.calls-filter-row{display:flex;gap:7px;flex-wrap:wrap}.calls-filter-chip{display:inline-flex;align-items:center;justify-content:center;min-height:34px;padding:6px 10px;border:1px solid #cbd5e1;border-radius:999px;background:#f7fafc;color:#425568;font-size:.72rem;font-weight:900;text-decoration:none}.calls-filter-chip.active{background:#18324a;border-color:#18324a;color:#fff}.calls-list{display:grid;gap:6px}.calls-row{display:grid;grid-template-columns:minmax(0,1fr) minmax(235px,350px);gap:10px;align-items:center;border-left:3px solid #6f8799;padding:8px 10px!important;border-radius:10px!important;box-shadow:0 3px 10px rgba(16,38,63,.05)!important}.calls-row.missed{border-left-color:#a65b5b}.calls-row-main{display:flex;align-items:center;gap:8px;min-width:0}.calls-direction-icon{width:28px;height:28px;border-radius:50%;display:flex;align-items:center;justify-content:center;background:#e8f4fb;color:#075f91;font-size:.88rem;font-weight:900;flex:0 0 auto}.calls-row-copy{min-width:0}.calls-row-title{display:flex;align-items:center;gap:6px;flex-wrap:wrap;line-height:1.1}.calls-row-title strong{font-size:.84rem;color:#243746}.calls-status-badge{display:inline-flex;padding:2px 5px;border-radius:999px;background:#eef3f6;color:#516273;font-size:.56rem;font-weight:900}.calls-status-badge.missed{background:#f7e9e9;color:#8b4545}.calls-row-meta{display:flex;gap:6px;flex-wrap:wrap;margin-top:3px;color:#6b7b8b;font-size:.66rem;font-weight:750;line-height:1.15}.calls-row-meta span+span{padding-left:6px;border-left:1px solid #d9e1e7}.calls-row-actions{display:grid;justify-items:end;gap:4px}.calls-action-buttons{display:flex;justify-content:flex-end;gap:5px;flex-wrap:wrap}.calls-row .btn,.calls-row button{min-height:28px!important;padding:5px 8px!important;border-radius:7px!important;font-size:.66rem!important;line-height:1!important}.calls-delete-button{border-color:#dccaca!important;color:#7c4848!important}.calls-recording-player{width:100%;height:28px;max-width:350px}.calls-unknown-label{font-size:.62rem;font-weight:850;color:#8a6454;background:#f6eee9;border-radius:6px;padding:3px 6px}@media(max-width:900px){.calls-summary-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.calls-row{grid-template-columns:1fr;gap:6px}.calls-row-actions{justify-items:stretch}.calls-action-buttons{justify-content:flex-start}.calls-recording-player{max-width:none}.ringcentral-calls-sync{justify-items:start}.ringcentral-calls-sync-message{text-align:left}}@media(max-width:560px){.calls-summary-grid{grid-template-columns:1fr 1fr;gap:8px}.calls-summary-card{padding:12px!important}.calls-summary-card strong{font-size:1.4rem}.calls-search-form{display:grid;grid-template-columns:1fr auto}.calls-search-form input[type=search]{min-width:0}.calls-filter-row{gap:6px}.calls-row{padding:7px 8px!important;gap:5px}.calls-row-main{gap:7px}.calls-direction-icon{width:26px;height:26px;font-size:.8rem}.calls-row-title strong{font-size:.8rem}.calls-row-meta{gap:5px;font-size:.62rem}.calls-row-meta span+span{padding-left:5px}.calls-page-heading{display:grid}.calls-page-heading .btn{width:100%}.calls-action-buttons{display:flex;width:100%;gap:5px}.calls-action-buttons .btn,.calls-action-buttons button{width:auto;flex:0 1 auto}.calls-recording-player{height:26px}.calls-unknown-label{justify-self:start}}
      `}</style>
    </div>
  )
}
